...
export function gradeAnswer(question: Question, userAnswerRaw: string, latencyMs: number): GradeResult {
...
function scoreQuality(correct: boolean, latencyMs: number, accuracy: "exact" | "minor" | "wrong"): number {
	if (!correct) return 1;
