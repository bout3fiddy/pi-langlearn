...
function sanitizeProfile(raw: any, lang: LangCode): Profile {
  ...
  const profile: Profile = {
    ...
    stats: {
      ...
      avgLatencyMs7d:
        typeof raw?.stats?.avgLatencyMs7d === "number" ? raw.stats.avgLatencyMs7d : undefined,
    },
    ability: {
      ...
      subskills:
        typeof raw?.ability?.subskills === "object" && raw.ability.subskills
    ...
    settings: {
      ...
      dailyNewCardsTarget: clampInt(
        raw?.settings?.dailyNewCardsTarget,
        fallback.settings.dailyNewCardsTarget,
        1,
        50,
      ),
