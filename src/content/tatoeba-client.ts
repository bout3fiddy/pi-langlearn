...
function pickTranslation(translations: TatoebaTranslation[], lang: string): TatoebaTranslation | null {
...
function buildAttribution(sentence: TatoebaSentence, translation: TatoebaTranslation): string {
	...
	const translationOwner = translation.owner ? `translation:${translation.owner}` : "translation:unknown";
